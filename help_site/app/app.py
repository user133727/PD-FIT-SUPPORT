...
@app.route('/templates/doc11')
def doc11():
    title = 'Техподдержка FIT'
    return render_template('doc11.html', title=title)

@app.route('/templates/doc12')
def doc12():
    title = 'Техподдержка FIT'
    return render_template('doc12.html', title=title)

@app.route('/templates/doc13')
def doc13():
    title = 'Техподдержка FIT'
